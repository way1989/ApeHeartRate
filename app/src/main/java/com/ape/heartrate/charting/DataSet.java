...
public class DataSet {
    ...
    private void calcMinMax() {
        ...
        boolean yMinChange = false;
        boolean yMaxChange = false;
        ...
        //Add by wusq, if the min value is equals to every item value, then the bar will not be drawn, so i try to avoid this instance.
