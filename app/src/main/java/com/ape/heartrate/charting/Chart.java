 ...
 * <ul>
 * <li>Draw the empty tip view when there is no data</li>
 * <li>Some common initial work</li>
 * <li>Give the implemention to draw the description</li>
 * <li></li>
 * </ul>
 * </p>
 */
public abstract class Chart extends View {
    ...
    public static final int PAINT_CONCLUDE = 17;
    public static final int PAINT_AVERAGE_LINE = 18;
    public static final int PAINT_AVERAGE_TEXT = 19;
    protected static final String LOG_TAG = "MPChart";
    private static final boolean DEBUG = true;
    private static final String TIPS_EMPTY = "No chart data available.";
    ...
    protected boolean isDrawDescription = false;
    /**
    ...
    private String mEmptyInfo = TIPS_EMPTY;
    ...
    protected void init() {
        ...
        mEmptyPaint.setColor(Color.rgb(247, 189, 51)); // orange
        mEmptyPaint.setTextAlign(Align.CENTER);
        mEmptyPaint.setTextSize(Utils.convertDpToPixel(12f));
    ...
    protected float[] measureTextDimension(Paint paint, String content) {
        Rect rect = new Rect();
    ...
    protected void calcMinMax() {
        ...
        log("mYChartMin write --- calcMinMax -- mYChartMin is " + mYChartMin);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mDataNotSet) { // check if there is data
            ...
            if (mEmptyInfo != null) {
                canvas.drawText(mEmptyInfo, getWidth() / 2, getHeight() / 2, mEmptyPaint);
            }
            return;
        }
...
//        mDrawCanvas.drawColor(Color.TRANSPARENT); // clear all
    }
    ...
    public void setDescriptionTextSize(float size) {
        ...
        mEmptyPaint.setTextSize(Utils.convertDpToPixel(size));
    }
     ...
     * @param bottom
     */
    public void setGraphOffsets(int left, int top, int right, int bottom) {
    ...
    public void setEmptyInfoTextSize(int dp) {
        mEmptyPaint.setTextSize(Utils.convertDpToPixel(dp));
    }

    public void setEmptyInfoTextColor(int color) {
    ...
    public void setData(ChartData data) {
        ...
        if (data == null || !data.isValid()) {
            log("Cannot set data for chart. Provided chart values are null or contain less than 2 entries.");
            mDataNotSet = true;
            return;
        }
    ...
    /**
     * If you want call this method, please call {@link #setBackgroundColor(int)} or {@link #setBackground(android.graphics.drawable.Drawable)} firstly
     * <p/>
