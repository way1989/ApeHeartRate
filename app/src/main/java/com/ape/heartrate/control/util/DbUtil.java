package com.ape.heartrate.control.util;

import android.content.Context;
import android.database.sqlite.SQLiteDatabase;

import com.ape.heartrate.greendao.DaoMaster;
import com.ape.heartrate.greendao.DaoSession;
import com.ape.heartrate.greendao.HistoryEntity;
import com.ape.heartrate.greendao.HistoryEntityDao;
...
//            maybe the order is not need,cause the calcuate time of later is always bigger than before.
    ...
    private static HistoryEntityDao getWriteDao(Context m_Context) throws IllegalArgumentException, SecurityException, IllegalAccessException, NoSuchFieldException, ClassNotFoundException {
    ...
    private static HistoryEntityDao getReadDao(Context m_Context) throws IllegalArgumentException, SecurityException, IllegalAccessException, NoSuchFieldException, ClassNotFoundException {
        DaoMaster.DevOpenHelper helper = new DaoMaster.DevOpenHelper(m_Context, DATABASE_NAME, null);
